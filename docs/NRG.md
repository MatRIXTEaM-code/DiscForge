...
Scope: **NRG v2 (NER5)** read and write. **NRG v1 (NERO)** is detected and
reported clearly but not yet read — a small addition (32-bit offsets, 30-byte
DAOI entries) once there is a v1 sample to test against. Sub-channel (2448-byte)
