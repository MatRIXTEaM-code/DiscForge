...
{
    public const int LeadInSectors = 22_500;                 // MSF 95:00:00 → 00:00:00
    private static readonly Msf LeadInStart = new(95, 0, 0);

    public static int SectorSize(RawSubcodeForm form)
        => form == RawSubcodeForm.Pq16 ? 2368 : 2448;

    /// <summary>Total sectors the image will contain (lead-in + program).</summary>
    public static long TotalSectors(DiscLayout layout)
    ...
    /// <summary>Generate the full image to <paramref name="output"/>.</summary>
