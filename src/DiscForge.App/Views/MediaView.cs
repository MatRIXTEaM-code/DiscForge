...
internal sealed class MediaView : UserControl
{
    ...
    // ---- CD+G ----
    private readonly TextBox _cdgIn = new() { ReadOnly = true, Location = new Point(70, 40), Width = 380, Font = Theme.Ui };
    private readonly TextBox _at = new() { Location = new Point(510, 40), Width = 70, Font = Theme.Mono };
    ...
    public MediaView()
    {
        ...
        cdgBox.Controls.Add(new Label { Text = "At (MM:SS):", AutoSize = true, Location = new Point(456, 43), Font = Theme.Ui });
        cdgBox.Controls.Add(new Label { Text = "blank = final frame", AutoSize = true, Location = new Point(586, 43), Font = Theme.Ui, ForeColor = Color.Gray });
